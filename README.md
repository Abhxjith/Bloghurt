...
[bloghurt.com](https://bloghurt.vercel.app)
...
Before you begin, ensure that you have your **Gemini API key** and **Firebase configuration keys** ready. These keys are necessary for the AI summary generation and Firebase services integration.

1. **Gemini API Key**: You'll need to generate a Gemini API key and store it in the `.env` file.
2. **Firebase Config Keys**: You will also need your Firebase configuration keys for authentication and database integration.
...
<img width="1438" alt="image" src="https://github.com/user-attachments/assets/e8b93ff6-3ccb-4f18-b2b1-d203f95f6a87" />
